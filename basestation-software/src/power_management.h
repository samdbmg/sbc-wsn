...
typedef enum {PWR_RADIO, PWR_DELAY, PWR_MODEM} power_system_t;
...
// Needed so that subsystems can find variable from this header
extern volatile uint8_t power_gpiod_use_count;
